export var VELOCITY_SCALE = 1 / 85000;           // scale for wind velocity (completely arbitrary--this value looks nice)
...
export var PARTICLE_LINE_WIDTH = 1.05;            // line width of a drawn particle
export var PARTICLE_MULTIPLIER = 6;              // particle count scalar (completely arbitrary--test)
export var PARTICLE_REDUCTION = 0.21;             // reduce particle count to this much of normal for mobile devices
